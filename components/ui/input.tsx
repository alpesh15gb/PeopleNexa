...
const base =
  "w-full rounded-[11px] border border-input bg-card px-3.5 text-base text-foreground placeholder:text-muted-foreground/55 transition-all duration-150 focus:border-primary/70 focus:outline-none focus:ring-4 focus:ring-ring/15 aria-[invalid=true]:border-destructive/60 aria-[invalid=true]:ring-destructive/15 disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm";
