...
assert.deepEqual(idCardTemplate({ frontBackgroundUrl: tenantAsset, backBackgroundUrl: tenantAsset }), { frontBackgroundUrl: tenantAsset, backBackgroundUrl: tenantAsset }, "uploaded first-party backgrounds are accepted");
