...
assert.equal(idCardTemplate({ frontBackgroundUrl: "https://cdn.example.com/front.png", backBackgroundUrl: "https://cdn.example.com/back.png" })?.frontContentPanel, "clean", "legacy templates default to a clean dynamic content panel");
