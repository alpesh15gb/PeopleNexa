...
export default async function AdminEmployeesPage({
  ...
  const employeeSelect = isLocationManager
    ? {
        ...
        education: { select: { qualification: true, specialization: true, institution: true, board: true, completionYear: true, grade: true }, orderBy: { completionYear: "desc" as const } },
        workExperience: { select: { employer: true, jobTitle: true, startDate: true, endDate: true, isCurrent: true, location: true, responsibilities: true }, orderBy: { startDate: "desc" as const } },
        managerId: true,
        profilePicture: true,
