...
const HEADERS = [
  ...
  "branch", "department", "shiftId", "payMode", "workBasisRate", "managerId", "status", "bankName", "accountNumber", "ifscCode", "pan", "uan", "aadhaarNumber", "drivingLicenseNumber", "drivingLicenseExpiresAt",
] as const;
...
export async function GET() {
  ...
  const employees = await prisma.employee.findMany({
    ...
    select: {
      ...
      joiningDate: true, payMode: true, workBasisRate: true, managerId: true, status: true, bankName: true, accountNumber: true, ifscCode: true, pan: true, uan: true, aadhaarNumber: true, drivingLicenseNumber: true, drivingLicenseExpiresAt: true,
